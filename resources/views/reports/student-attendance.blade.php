<x-admin-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ __('Relatório de Frequência de Alunos') }}
        </h2>
    </x-slot>
    ...
    <div class="px-6 py-4">
        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
            <div class="grid items-end grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <!-- Aluno -->
              <div>
    <label for="student_id" class="block mb-1 text-sm font-medium text-gray-700">Aluno</label>
    <select id="student_id" name="student_id" placeholder="Digite para buscar..."
    ...
    load: function (query, callback) {
        ...
        fetch(`/reports/person-search?term=${encodeURIComponent(query)}&type={{ $type }}`)
            .then(res => res.json())
    ...
    function buscarRelatorio() {
        ...
        fetch(`/reports/student-attendance/data?${queryParams.toString()}`, {
            headers: {
