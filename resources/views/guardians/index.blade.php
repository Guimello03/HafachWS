<x-admin-layout>
    <div x-data="photoModal()">
        ...
        @endif
        <div class="px-6 pt-6">
            <h2 class="mb-4 text-xl font-extrabold text-gray-900">Listagem de Responsáveis</h2>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            @foreach ($guardians as $index => $guardian)
                                <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }}">
                                    ...
                                    <td class="px-4 py-2 text-center">{{ $guardian->cpf }}</td>
                                    <td class="px-4 py-2">
                                        {{ \Carbon\Carbon::parse($guardian->birth_date)->format('d/m/Y') }}</td>
                                    <td class="px-4 py-2 text-center">{{ $guardian->email }}</td>
